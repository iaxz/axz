...
[【前端开发】](/views/frontend/web.html) | [【后端开发】](/views/backend/work.html)

</div>

<div id='se'>

[【规范】](/views/specification/gf.html) | [【灵感记录】](/views/record/20211214.html)

</div>

<CatalogGraph  root='/views/' title='本站指南' :height='320' />
		...
		methods: {
    		randomPic() {
				...
				setInterval(() => {
					...
					this.imgSrc = '/axz/view/' + picList[Math.floor(Math.random() * picList.length)]
